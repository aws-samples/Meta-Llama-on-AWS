...
from llama4_coordinator_agent import new_llama4_coordinator_agent  # factory function
import gradio as gr
...
# def get_latest_analysis(video_file_path):
#     """Retrieve the latest analysis TXT file from S3 for this video"""
#     if not video_file_path:
#         return None
...
#     response = s3.list_objects_v2(Bucket=bucket, Prefix=f"videos/{base_name}/")
#     if 'Contents' not in response:
#         return None
...
#         agent = new_llama4_coordinator_agent()
#         chat_history.append(("assistant", "⏳ Running video processing pipeline..."))
#         video_instruction = f"Process a video from {s3_video_uri}"
#         chat_history.append(("user", video_instruction))
...
#         if analysis_data:
#             chat_history.append(("assistant", "✅ Analysis complete! Here is your summary:"))
#             chat_history.append(("assistant", analysis_data))
#         else:
#             chat_history.append(("assistant", "❌ Processing failed - no summary generated"))
...
# with gr.Blocks() as demo:
#     gr.Markdown("# 🎬 Llama4 Video Analysis Chatbot\nUpload a video file for interactive, step-by-step AI video analysis.")
#     gr.Markdown("⚠️ **Note:** Analysis may take several minutes (frame extraction, AI reasoning, and summary generation).")
#     chatbot = gr.Chatbot(label="Llama4 Video Analysis Log")
#     upload = gr.File(
#         label="Upload Video File",
#         file_types=["video"],
