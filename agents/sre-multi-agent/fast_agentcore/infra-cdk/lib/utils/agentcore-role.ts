        ...
        AgentCorePolicy: new iam.PolicyDocument({
          statements: [
            ...
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:logs:${region}:${accountId}:log-group:/aws/banking/system-logs`,
                `arn:aws:logs:${region}:${accountId}:log-group:/aws/banking/system-logs:log-stream:*`,
              ],
            }),
            new iam.PolicyStatement({
              effect: iam.Effect.ALLOW,
